...
@Autonomous(name = "BlueAutoFar_Full", group = "Auto")
public class BlueAutoFar extends LinearOpMode {
    ...
    // Poses
    private final Pose startPose = new Pose(43, 0, Math.toRadians(270));
    private final Pose shootPose = new Pose(48, 96, Math.toRadians(315));
    private final Pose intake1Pose = new Pose(40, 84, Math.toRadians(90));
    private final Pose intake2Pose = new Pose(40, 60, Math.toRadians(90));
    private final Pose intake3Pose = new Pose(40, 36, Math.toRadians(90));
    private final Pose intake1donePose = new Pose(16, 84, Math.toRadians(90));
    private final Pose intake2donePose = new Pose(16, 60, Math.toRadians(90));
    private final Pose intake3donePose = new Pose(16, 36, Math.toRadians(90));
    private final Pose leave = new Pose(40, 84, Math.toRadians(315));
